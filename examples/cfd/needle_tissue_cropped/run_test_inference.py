...
def _get_test_run_ids(
    ...
    """Return test run IDs using the same split logic as infer.py."""
...
def main():
    ...
    parser.add_argument(
        "--data_dir",
        default="/home/nathanielhoffman/Desktop/cel/physicsnemo/RUN-2",
        help="Directory containing raw VTU files (must match config.yaml data_dir)",
    )
    parser.add_argument(
        "--infer_output_base",
