...
class MeshGraphNet(Module):
    ...
    def __init__(
        ...
        if use_fourier_features:
            self.node_fourier = FourierFeatureTransform(
                input_dim_nodes, n_fourier_features, fourier_scale
            )
            node_encoder_in = self.node_fourier.out_features
        else:
            self.node_fourier = None
            node_encoder_in = input_dim_nodes
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.use_fourier_features:
            node_features = self.node_fourier(node_features)
