#!/bin/bash
#SBATCH --job-name=ndl_crp_fourier
...
#SBATCH --output=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_fourier/slurm-%j.out
#SBATCH --error=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_fourier/slurm-%j.err

# Experiment: Cropped MGN + Fourier features — no noise, Fourier node encoding, no cpress
...
EXP=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_fourier
