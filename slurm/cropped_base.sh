...
#SBATCH --output=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_base/slurm-%j.out
#SBATCH --error=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_base/slurm-%j.err

# Experiment: Cropped MGN base — no gaussian noise, no Fourier features, no cpress
...
EXP=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_base
