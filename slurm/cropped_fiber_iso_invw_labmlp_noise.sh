#!/bin/bash
#SBATCH --job-name=ndl_crp_fbr_invw_labmlp_noise
...
#SBATCH --output=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_fiber_iso_invw_labmlp_noise/slurm-%j.out
#SBATCH --error=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_fiber_iso_invw_labmlp_noise/slurm-%j.err
...
EXP=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_fiber_iso_invw_labmlp_noise
