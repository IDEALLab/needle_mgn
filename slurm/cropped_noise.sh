...
#SBATCH --output=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_noise/slurm-%j.out
#SBATCH --error=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_noise/slurm-%j.err

# Experiment: Cropped MGN + gaussian noise — noise_std=3e-3, no Fourier features, no cpress
...
EXP=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_noise
