#!/bin/bash
#SBATCH --job-name=ndl_dom_cpress
...
#SBATCH --output=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_cpress/slurm-%j.out
#SBATCH --error=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_cpress/slurm-%j.err

# Experiment: DoMINO + cpress — no noise, no Fourier features, cpress enabled
...
EXP=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_cpress
