#!/bin/bash
#SBATCH --job-name=ndl_crp_cpress
...
#SBATCH --output=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_cpress/slurm-%j.out
#SBATCH --error=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_cpress/slurm-%j.err

# Experiment: Cropped MGN + cpress — no noise, no Fourier features, cpress enabled
...
EXP=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/cropped_cpress
