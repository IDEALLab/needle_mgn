#!/bin/bash
#SBATCH --job-name=ndl_dom_fourier
...
#SBATCH --output=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_fourier/slurm-%j.out
#SBATCH --error=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_fourier/slurm-%j.err

# Experiment: DoMINO + Fourier features on state — no noise, Fourier state encoding, no cpress
...
EXP=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_fourier
...
apptainer exec --nv \
    ...
    ${SIF} \
    uv run python /opt/needle_mgn/examples/cfd/needle_tissue_domino/train.py \
        wandb_mode=offline \
