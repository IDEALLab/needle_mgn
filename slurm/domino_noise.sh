...
#SBATCH --output=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_noise/slurm-%j.out
#SBATCH --error=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_noise/slurm-%j.err

# Experiment: DoMINO + gaussian noise — noise_std=3e-3, no Fourier features, no cpress
...
EXP=/home/nhoffma1/scratch.fuge-prj/needle_mgn/experiments/domino_noise
